...
>
	{#snippet children({ thumbItems })}
		<span
			...
			class={cn(
				'relative grow overflow-hidden rounded-full bg-input/90 data-horizontal:h-2 data-horizontal:w-full data-horizontal:w-full data-vertical:h-full data-vertical:h-full data-vertical:w-2'
			)}
		>
